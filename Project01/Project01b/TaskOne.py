...
ScatterplotMode.Task(0,"1","Basic Operations Used in Finding Fib(k)","ith Element of Fibonacci Sequence","Basic Operations",range(2,100),[""],[euclidGCDSPWrapper])
...
#ScatterplotMode.Task(0,"1","Basic Operations Used in Finding GCD(m,n)","ith Element of Fibonacci Sequence","Basic Operations",range(2,500),[""],[euclidGCDSPWrapper])